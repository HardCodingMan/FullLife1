...
public class M_member {
	...
	public M_member(String mId, String mPwd, String mName, String mZumin, String mAddr, String mPhone) {
		super();
		this.userId = mId;
		this.userPwd = mPwd;
		this.userName = mName;
	...
	public String toString() {
		return "M_member [userId=" + userId + ", userNo=" + userNo + ", userPwd=" + userPwd + ", userName=" + userName
				+ ", zumin=" + zumin + ", addr=" + addr + ", phone=" + phone + ", regDate=" + regDate 
				+ ", enrolled=" + enrolled + ", point=" + point + "]";
	}
