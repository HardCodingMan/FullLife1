...
<%--                             <option value="gwangju"<c:if test="${metroCity eq 'gwangju' }">selected</c:if>>광주</option> --%>
            ...
            <div id="hosDetail">
                <div id="viewHos">
    				...
    				<label><input type="hidden" id="hospital-name" name="chosen-hospital"><b style="font-size:25px">${hospital.hospitalName }</b>
                ...
                <div id="dateTime">
					...
					<script>
				            ...
				            geocoder.addressSearch('${hospital.hospitalAddr}', function(result, status) {
